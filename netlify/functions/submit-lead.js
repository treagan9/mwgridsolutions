        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td style="text-align:right;vertical-align:top;">
              <div style="background:#0ea5a8;color:#ffffff;font-size:11px;font-weight:800;padding:5px 12px;border-radius:20px;display:inline-block;text-transform:uppercase;">${photoUrls.length} Photo${photoUrls.length !== 1 ? 's' : ''}</div>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td class="mobile-pad" style="padding:28px 40px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
          <tr><td style="padding:16px 18px;background:#f8fafc;border:1px solid #e2e8f0;border-left:4px solid #0ea5a8;border-radius:4px;">${descriptionHtml}</td></tr>
        </table>
...
// ============================================
// HANDLER - CommonJS Netlify Functions v1
// ============================================
